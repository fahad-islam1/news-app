...
import 'package:url_launcher/url_launcher.dart'; // Add this line to import url_launcher

class TopHomeDetailScreen extends StatefulWidget {
  final String hintText, title, description;
  final Color color;
  ...
  @override
  State<TopHomeDetailScreen> createState() => _TopHomeDetailScreenState();
}

class _TopHomeDetailScreenState extends State<TopHomeDetailScreen> {
  @override
